...
CompressAI-based models are typically compared againts a well-known "anchor" pipeline, featuring a classical/standard image/video codec, say, H266.
...
evaluation protocols (OpenImageV6) and anchor pipelines (VTM/H266 based)
