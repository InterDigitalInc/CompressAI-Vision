...
def main(p):
    ...
    print()
    if p.lists is None:
        print("WARNING: using/registering with ALL images.  You should use the --lists option")
        n_images="?"
        image_ids=None
    else:
    ...
    label_types=["classifications"] # at least image-level classifications required..!
