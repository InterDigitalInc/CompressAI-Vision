...
class EncodingDecodingDatasetMapper(DatasetMapper):
    ...
    def __call__(self, dataset_dict):
        ...
        if self.image_format == "BGR":
            bpp, image=self.encdec.BGR(image) # cruch image through the encoder/decoder process on-the-fly
        else:
            raise(AssertionError("don't know how to handle format " + self.image_format))
