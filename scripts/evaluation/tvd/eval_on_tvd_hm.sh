...
EXAMPLE         [bash eval_on_mpeg_tvd_hm.sh -t /path/to/testdata -p split -i /path/to/HM_repo -d cpu -q 32 -s Traffic_2560x1600_30_val]
_EOF_
            exit;
            ;;
...
DATASET_INFO_PATH="${SCRIPT_DIR}/tvd.json"
