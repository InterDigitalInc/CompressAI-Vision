...
EXAMPLE         [bash eval_on_mpeg_sfu_hw_hm.sh -t /path/to/testdata -p split -i /path/to/HM_repo -d cpu -q 32 -s Traffic_2560x1600_30_val]
_EOF_
            exit;
            ;;
...
#++vision_model.yolox_darknet53.splits=${SPLIT} \
