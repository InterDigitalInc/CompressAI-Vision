...
${ENTRY_CMD} --config-name=${CONF_NAME}.yaml \
             pipeline.type=image \
             paths._run_root=/tmp/cav-fasterrcnn-mobilenet-coco-val2017 \
             vision_model.arch=fasterrcnn_mobilenet_v3_large_320_fpn \
             ...
             dataset.config.dataset_name=coco-val2017 \
